...
include('connect.php');
  ...
  header("Location: http://localhost/Projekt/api/question.php");}
  else{
   $validation_error = 'Podana ankieta istnieje';
  header("refresh:4;url=http://localhost/Projekt/api/create.php");
 ...
 */
>>>>>>> 7046241c8c6747e1bfb263f982ae20c5f1e4553d
