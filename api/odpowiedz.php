<?php
/**
 * Plik odpowiada za wyświetlanie użytkownikowi ankiet na kótre może odpowiedzieć
 */
session_start();
   ...
   <?php endif?>
        ...
        <div class="row">
            ...
            <div class="panel panel-default">
                <div class="panel-heading" id="panelek">Ankiety udostępnione użytkownikowi do odpowiedzi</div>
